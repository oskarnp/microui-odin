...
ATLAS_WIDTH       :: 128;
ATLAS_HEIGHT      :: 128;
ATLAS_WHITE       :: cast(int)mu.Icon.MAX + 0;
ATLAS_FONT        :: cast(int)mu.Icon.MAX + 1;
MU_ICON_CLOSE     :: cast(int)mu.Icon.CLOSE;
MU_ICON_CHECK     :: cast(int)mu.Icon.CHECK;
MU_ICON_EXPANDED  :: cast(int)mu.Icon.EXPANDED;
MU_ICON_COLLAPSED :: cast(int)mu.Icon.COLLAPSED;

@static atlas_texture := [?]u8{
